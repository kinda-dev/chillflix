...
#   Character.create(name: 'Luke', movie: movies.first)
    ...
    list1 = MyList.create!(movie_id: movie12.id, profile_id: user1.id)
    list2 = MyList.create!(movie_id: movie18.id, profile_id: user1.id)
    list3 = MyList.create!(movie_id: movie13.id, profile_id: user1.id)

    #moviesgenres
    
    moviesgenres1 = MoviesGenre.create!(genre_id: genre1.id,movie_id:movie1.id)
    moviesgenres2 = MoviesGenre.create!(genre_id: genre1.id,movie_id:movie2.id)
    moviesgenres3 = MoviesGenre.create!(genre_id: genre1.id,movie_id:movie3.id)
    moviesgenres4 = MoviesGenre.create!(genre_id: genre1.id,movie_id:movie4.id)
    moviesgenres5 = MoviesGenre.create!(genre_id: genre1.id,movie_id:movie5.id)
    moviesgenres6 = MoviesGenre.create!(genre_id: genre1.id,movie_id:movie6.id)
    moviesgenres7 = MoviesGenre.create!(genre_id: genre1.id,movie_id:movie7.id)
    moviesgenres8 = MoviesGenre.create!(genre_id: genre1.id,movie_id:movie8.id)
    moviesgenres9 = MoviesGenre.create!(genre_id: genre1.id,movie_id:movie9.id)
    moviesgenres10 = MoviesGenre.create!(genre_id: genre1.id,movie_id:movie10.id)
    moviesgenres11 = MoviesGenre.create!(genre_id: genre1.id,movie_id:movie11.id)
    moviesgenres12 = MoviesGenre.create!(genre_id: genre1.id,movie_id:movie12.id)
    moviesgenres13 = MoviesGenre.create!(genre_id: genre1.id,movie_id:movie13.id)
    moviesgenres14 = MoviesGenre.create!(genre_id: genre1.id,movie_id:movie14.id)
    moviesgenres15 = MoviesGenre.create!(genre_id: genre1.id,movie_id:movie15.id)
    moviesgenres16 = MoviesGenre.create!(genre_id: genre1.id,movie_id:movie16.id)
    moviesgenres17 = MoviesGenre.create!(genre_id: genre1.id,movie_id:movie17.id)
    moviesgenres18 = MoviesGenre.create!(genre_id: genre1.id,movie_id:movie18.id)
    moviesgenres19 = MoviesGenre.create!(genre_id: genre1.id,movie_id:movie19.id)
    moviesgenres20 = MoviesGenre.create!(genre_id: genre2.id,movie_id:movie2.id)
    moviesgenres21 = MoviesGenre.create!(genre_id: genre2.id,movie_id:movie4.id)
    moviesgenres22 = MoviesGenre.create!(genre_id: genre2.id,movie_id:movie7.id)
    moviesgenres23 = MoviesGenre.create!(genre_id: genre2.id,movie_id:movie8.id)
    moviesgenres24 = MoviesGenre.create!(genre_id: genre3.id,movie_id:movie1.id)
    moviesgenres25 = MoviesGenre.create!(genre_id: genre3.id,movie_id:movie10.id)
    moviesgenres26 = MoviesGenre.create!(genre_id: genre3.id,movie_id:movie14.id)
    moviesgenres27 = MoviesGenre.create!(genre_id: genre3.id,movie_id:movie15.id)
    moviesgenres28 = MoviesGenre.create!(genre_id: genre4.id,movie_id:movie3.id)
    moviesgenres29 = MoviesGenre.create!(genre_id: genre4.id,movie_id:movie5.id)
    moviesgenres30 = MoviesGenre.create!(genre_id: genre4.id,movie_id:movie6.id)
    moviesgenres31 = MoviesGenre.create!(genre_id: genre4.id,movie_id:movie9.id)
    moviesgenres32 = MoviesGenre.create!(genre_id: genre4.id,movie_id:movie11.id)
    moviesgenres33 = MoviesGenre.create!(genre_id: genre4.id,movie_id:movie13.id)
    moviesgenres34 = MoviesGenre.create!(genre_id: genre4.id,movie_id:movie17.id)
    moviesgenres35 = MoviesGenre.create!(genre_id: genre4.id,movie_id:movie18.id)
    moviesgenres36 = MoviesGenre.create!(genre_id: genre4.id,movie_id:movie19.id)
